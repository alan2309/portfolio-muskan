...
function About() {
  return (
    ...
    <div className="hero">
      ...
      <div>
        <a class="btn btn-branding" href='/' download="Alankrit's Resume.pdf">
          My Resume
        </a>
      </div>
    </div>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#f9f7fe" fill-opacity="1" d="M0,192L80,197.3C160,203,320,213,480,202.7C640,192,800,160,960,170.7C1120,181,1280,235,1360,261.3L1440,288L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"></path></svg>
    </div>
  );
}
